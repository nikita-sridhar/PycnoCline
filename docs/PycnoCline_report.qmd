...
**Analysis of urchin grazing data for PycnoCline experiment on sunflower star indirect effects on kelp conducted in Sitka, AK in summer of 2023.**
...
Investigating distribution of response variable (change in kelp weight) to determine which model to use, and testing for normality.
...
Calculating estimated marginal means from the linear mixed-effects model, and calculating pairwise contrasts based on a priori hypotheses using custom contrast weights.
...
Bar chart of raw data showing change in kelp weight across treatments, with significance bars manually added based on significant pairwise contrasts.
